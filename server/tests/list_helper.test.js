...
describe('favorite blog', () => {
  ...
  test('when list has multiple blogs with equal likes equals the first with most likes', () => {
    const blogs = [
      {
        _id: "5a422b891b54a676234d17fa",
        title: "First class tests",
...
describe('most blogs', () => {
  ...
  test('when list has multiple authors with equal amount of blogs equals the first with most blogs', () => {
    const blogs = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
...
describe('most likes', () => {
  ...
  test('when list has multiple authors with equal amount of likes equals the first with most likes', () => {
    const blogs = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
